...
const R41OptimisticUpdatesForSingleEntityQueriesRoute =
  R41OptimisticUpdatesForSingleEntityQueriesRouteImport.update({
    id: '/41-optimistic-updates-for-single-entity-queries',
...
const R33PrefetchingAndStaleTimeRoute =
  R33PrefetchingAndStaleTimeRouteImport.update({
    id: '/33-prefetching-and-stale-time',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/42-rollbacks-for-single-entity-queries': {
      id: '/42-rollbacks-for-single-entity-queries'
      path: '/42-rollbacks-for-single-entity-queries'
      fullPath: '/42-rollbacks-for-single-entity-queries'
      preLoaderRoute: typeof R42RollbacksForSingleEntityQueriesRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/41-optimistic-updates-for-single-entity-queries': {
      id: '/41-optimistic-updates-for-single-entity-queries'
      path: '/41-optimistic-updates-for-single-entity-queries'
      fullPath: '/41-optimistic-updates-for-single-entity-queries'
      preLoaderRoute: typeof R41OptimisticUpdatesForSingleEntityQueriesRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/40-rollbacks-for-list-like-queries': {
      id: '/40-rollbacks-for-list-like-queries'
    ...
    '/39-optimistic-updates-for-list-like-queries': {
      id: '/39-optimistic-updates-for-list-like-queries'
      path: '/39-optimistic-updates-for-list-like-queries'
      fullPath: '/39-optimistic-updates-for-list-like-queries'
      preLoaderRoute: typeof R39OptimisticUpdatesForListLikeQueriesRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/38-updating-query-data-with-mutation-responses': {
      id: '/38-updating-query-data-with-mutation-responses'
    ...
    '/36-mutations-with-the-usemutation-hook': {
      id: '/36-mutations-with-the-usemutation-hook'
      path: '/36-mutations-with-the-usemutation-hook'
      fullPath: '/36-mutations-with-the-usemutation-hook'
      preLoaderRoute: typeof R36MutationsWithTheUsemutationHookRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/35-mutations-overview': {
      id: '/35-mutations-overview'
    ...
    '/34-forced-prefetching': {
      id: '/34-forced-prefetching'
      path: '/34-forced-prefetching'
      fullPath: '/34-forced-prefetching'
      preLoaderRoute: typeof R34ForcedPrefetchingRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/33-prefetching-and-stale-time': {
      id: '/33-prefetching-and-stale-time'
      path: '/33-prefetching-and-stale-time'
      fullPath: '/33-prefetching-and-stale-time'
      preLoaderRoute: typeof R33PrefetchingAndStaleTimeRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/32-hover-based-query-prefetching': {
      id: '/32-hover-based-query-prefetching'
    ...
    '/30-invalidating-multiple-queries-with-similar-query-keys': {
      id: '/30-invalidating-multiple-queries-with-similar-query-keys'
      path: '/30-invalidating-multiple-queries-with-similar-query-keys'
      fullPath: '/30-invalidating-multiple-queries-with-similar-query-keys'
      preLoaderRoute: typeof R30InvalidatingMultipleQueriesWithSimilarQueryKeysRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/29-invalidating-and-refetching-inactive-queries': {
      id: '/29-invalidating-and-refetching-inactive-queries'
